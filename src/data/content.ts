...
export const rooms = [
  ...
  }, 
  {
    ...
    desc: {
      en: 'Our finest suite — a king bedroom, private dining area, and a terrace overlooking the Hossana hills. The ultimate Shembelala Hotel experience.',
...
export const menuItems = [
  ...
  { id: 'm5', name: { en: 'Shembelala Special', am: 'ፍርፍር', had: 'Shembelala special' }, desc: { en: 'Shredded injera tossed in spiced berbere sauce with onion and butter. A classic breakfast.', am: 'የተቀቀለ እንጀራ ከበርበሬ ጋር።', had: 'Shredded injera, berbere.' }, price: 220, category: 'breakfast' as MenuCategory, image: '/assets/Images/menu/shembelalaspecial.webp', tags: ['spicy', 'vegetarian'] },
